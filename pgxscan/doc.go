...
pgx has a concept of custom types: https://pkg.go.dev/github.com/jackc/pgx/v5?tab=doc#hdr-Custom_Type_Support.
...
pgxscan only works with pgx v5. So the import path of your pgx must be: "github.com/jackc/pgx/v5".
*/
package pgxscan
